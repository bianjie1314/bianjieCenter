...
public enum RespCode {
    ...
    CODE_10507(10507, "登录用户和密码有误，请重新输入"),
    ...
    CODE_10522(10522, "登录用户已存在"),
    CODE_10528(10528, "查询详单无数据"),
    CODE_10529(10529, "调用支付转款失败，请稍后再试"),
    CODE_10530(10530, "调用数据库失败，请稍后再试"),
    CODE_10533(10533, "订单状态异常，请联系客服"),
    CODE_10538(10538, "该公告非待上架公告，无法操作");
